...
Inputs:
    ...
    Data/Spanish/layers/sense_assignments_lemma.json (optional, preferred)
...
def main():
    ...
    assignments_path = LAYERS / "sense_assignments_lemma.json"
    assignments_label = "sense_assignments_lemma"
    if not assignments_path.exists():
        assignments_path = LAYERS / "sense_assignments.json"
        assignments_label = "sense_assignments"
