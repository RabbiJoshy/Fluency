#!/usr/bin/env python3
"""
step_6a_assign_senses.py — Assign example sentences to word senses.
...
Usage:
    python3 pipeline/step_6a_assign_senses.py                      # gemini, no merge
    python3 pipeline/step_6a_assign_senses.py --gemini --merge     # gemini + merge
    python3 pipeline/step_6a_assign_senses.py --english-only       # gemini, English-only
    python3 pipeline/step_6a_assign_senses.py --biencoder          # bi-encoder + merge
    python3 pipeline/step_6a_assign_senses.py --keyword-only       # instant fallback
