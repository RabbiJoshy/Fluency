...
Usage (from project root):
    .venv/bin/python3 Artists/scripts/translate_sentences_google.py --artist-dir "Artists/Young Miko"
    .venv/bin/python3 Artists/scripts/translate_sentences_google.py --artist-dir "Artists/Rosalía"
    .venv/bin/python3 Artists/scripts/translate_sentences_google.py --artist-dir "Artists/Young Miko" --dry-run
"""
