...
Usage (from project root):
    .venv/bin/python3 Artists/scripts/judge_translations.py --artist-dir "Artists/Young Miko"
    .venv/bin/python3 Artists/scripts/judge_translations.py --artist-dir "Artists/Young Miko" --judge-only
    .venv/bin/python3 Artists/scripts/judge_translations.py --artist-dir "Artists/Young Miko" --threshold 3
"""
...
from _artist_config import add_artist_arg, load_artist_config, load_dotenv_from_project_root
