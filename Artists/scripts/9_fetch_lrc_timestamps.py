...
Usage (from project root):
    .venv/bin/python3 Artists/scripts/9_fetch_lrc_timestamps.py --artist-dir "Artists/Bad Bunny"
    .venv/bin/python3 Artists/scripts/9_fetch_lrc_timestamps.py --artist-dir "Artists/Bad Bunny" --force-refetch
"""
