...
- **[now] Notes-app UI batch — requested 2026-07-24 [shared unless noted]**
  ...
  10. **(M) [shared] Separate unseen learning from unresolved review** — DONE 2026-07-26
      (`78b33505`; progress visual refined `3fb24b2d`): stable-set completion now measures cards seen, Learn new loads only unseen
      ...
      the card without erasing its historical counts. Set cells use fixed semantic proportions for
      Known, Review, and Unseen rather than source-themed fill, with exact counts replacing the old
      ambiguous review-number badge.
...
- **[now] Codex follow-up batch — requested 2026-07-25 [shared unless noted]**
  ...
  11. **(L) [artist/spanish] Split recurring vocabulary from Artist Extra** — DONE 2026-07-25
      ...
      dictionary senses and Speech examples without requiring Gemini, always retains the artist lyric,
      and admits lyric-only cards with an explicit missing-translation state. There is no third
      “readiness” category and no provisional Extra-only Learn later/Flag/Skip workflow; those controls
      wait for a comprehensive cross-mode review design.
