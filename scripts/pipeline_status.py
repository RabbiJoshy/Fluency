...
STEPS = [
    ...
    # Phase 4 — Route
    {
        ...
        "current_version": 1,
        "notes": {1: "initial versioned schema; shared util_4a_routing for clitic + derivation helpers"},
    ...
    },
    {
        ...
        "label": "5c sense_menu",
        "current_version": 1,
        "notes": {1: "step_5c_build_senses.py (shared; --artist-dir routes to artist layers)"},
    ...
    },
    {
        ...
        "depends_on": ["7a_lemma_assignments", "7c_cognates"],
    ...
    },
    {
        ...
        "depends_on": ["7a_lemma_assignments", "5a_examples",
                       "5b_conjugations", "5d_mwes", "7c_cognates"],
        "artist_output": None,
