...
Usage (from project root):
    ...
    .venv/bin/python3 "Bad Bunny/1b_rescrape_nulls.py"

    # Dry run — show what would be re-scraped
    .venv/bin/python3 "Bad Bunny/1b_rescrape_nulls.py" --dry-run

    # Only re-scrape non-variant songs (skip remixes/live)
    .venv/bin/python3 "Bad Bunny/1b_rescrape_nulls.py" --skip-variants

    # Also scrape specific song IDs (adds to a new batch file)
    .venv/bin/python3 "Bad Bunny/1b_rescrape_nulls.py" --add-ids 12345 67890
"""
