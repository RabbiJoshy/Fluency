#!/usr/bin/env python3
"""
Step 4: LLM-based vocabulary analysis using Gemini API.
...
Reads intermediates/3_vocab_evidence_merged.json
...
INPUT_PATH = os.path.join(SCRIPT_DIR, "intermediates", "3_vocab_evidence_merged.json")
...
# These always win over LLM output. Never delete entries.
# ---------------------------------------------------------------------------
