...
PROJECT_ROOT = os.path.dirname(PIPELINE_DIR)  # Bad Bunny/ -> Fluency/
...
add_transparent_flag(os.path.join(PIPELINE_DIR, "BadBunnyvocabulary.json"), intersection_mode=True)
