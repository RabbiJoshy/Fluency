    ...
    if (card.isMultiMeaning) {
        ...
        if (currentMeaning && currentMeaning.targetSentence) {
            ...
            const spotifyBtn = spotifyTrackId
                ? `<span class="spotify-btn link-btn" onclick="event.stopPropagation(); spotifyPlayTrack('${spotifyTrackId}', ${positionMs})" title="Play in Spotify" style="cursor:pointer;">${spotifySvg}</span>`
