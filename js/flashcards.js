    ...
    if (card.isMultiMeaning) {
        ...
        card.meanings.forEach((m, idx) => {
            ...
            if (isMWE) {
                ...
                target.push(`
                <div class="meaning-row meaning-row-cycle" style="display: grid; grid-template-columns: auto 1fr auto; align-items: center; padding: 6px 4px; margin-bottom: 6px; background: ${bgColor}; ${borderStyle} border-radius: 8px; cursor: pointer; min-height: 36px; opacity: 0.75;" onclick="selectMeaning(${idx})">
                ...
                target.push(`
                <div class="meaning-row meaning-row-regular" style="display: grid; grid-template-columns: auto 1fr auto; align-items: center; padding: 6px 4px; margin-bottom: 6px; background: ${bgColor}; ${borderStyle} border-radius: 8px; cursor: pointer; min-height: 36px;" onclick="selectMeaning(${idx})">
                    ${posPill}
