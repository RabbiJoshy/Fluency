import './state.js?v=20260804d';
import './offline-db.js?v=20260804d';
import './sync-queue.js?v=20260804d';
import { initOfflineContent } from './offline-content.js?v=20260804d';
import './speech.js?v=20260804d';
import './artist-ui.js?v=20260804d';
import './auth.js?v=20260804d';
import './estimation.js?v=20260804d';
import './config.js?v=20260804d';
import './progress.js?v=20260804d';
import './knowledge.js?v=20260804d';
import './ui.js?v=20260804d';
import './vocab.js?v=20260804d';
import './flashcards.js?v=20260804d';
...
const _spotifyModulePromise = (_initialParams.has('artist') || _initialParams.get('mode') === 'badbunny')
    ? import('./spotify.js?v=20260804d').catch(error => {
...
loadConfig().then(async () => {
    ...
    if (_speechVnextRoute) {
        try {
            ...
            applyLanguageColorTheme();
            const speechVnext = await import('./speech-vnext.js?v=20260804d');
