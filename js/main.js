...
import './offline-db.js?v=20260815b';
import './sync-queue.js?v=20260815b';
import { initOfflineContent } from './offline-content.js?v=20260815b';
import './speech.js?v=20260815b';
import './artist-ui.js?v=20260815b';
import './auth.js?v=20260815b';
import './about-example.js?v=20260815b';
import './estimation.js?v=20260815b';
import './config.js?v=20260815b';
import './progress.js?v=20260815b';
import './knowledge.js?v=20260815b';
import './ui.js?v=20260815b';
import './vocab.js?v=20260815b';
import './flashcards.js?v=20260815b';
...
const _spotifyModulePromise = (_initialParams.has('artist') || _initialParams.get('mode') === 'badbunny')
    ? import('./spotify.js?v=20260815b').catch(error => {
...
loadConfig().then(async () => {
    ...
    if (_speechVnextRoute) {
        try {
            ...
            applyLanguageColorTheme();
            const speechVnext = await import('./speech-vnext.js?v=20260815b');
