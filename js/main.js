import './state.js?v=20260816c';
import './offline-db.js?v=20260816c';
import './sync-queue.js?v=20260816c';
import { initOfflineContent } from './offline-content.js?v=20260816c';
import './speech.js?v=20260816c';
import './artist-ui.js?v=20260816c';
import './auth.js?v=20260816c';
import './about-example.js?v=20260816c';
import './estimation.js?v=20260816c';
import './config.js?v=20260816c';
import './progress.js?v=20260816c';
import './knowledge.js?v=20260816c';
import './ui.js?v=20260816c';
import './vocab.js?v=20260816c';
import './flashcards.js?v=20260816c';
...
const _spotifyModulePromise = (_initialParams.has('artist') || _initialParams.get('mode') === 'badbunny')
    ? import('./spotify.js?v=20260816c').catch(error => {
...
loadConfig().then(async () => {
    ...
    if (_speechVnextRoute) {
        try {
            ...
            applyLanguageColorTheme();
            const speechVnext = await import('./speech-vnext.js?v=20260816c');
